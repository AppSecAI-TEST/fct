...
public class OrderCommentController extends BaseController {
    ...
    public ReturnValue saveComment(String order_id, Integer express_score,
                                   Integer has_anonymous, Integer sale_score, String product_info) {
        ...
        List<OrderComment> lsComment = JsonConverter.toObject(product_info, new TypeReference<List<OrderComment>>(){});

        mallService.createOrderCommment(member.getMemberId(), order_id, has_anonymous, express_score, sale_score, lsComment);
