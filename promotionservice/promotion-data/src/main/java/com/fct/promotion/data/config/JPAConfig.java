package com.fct.promotion.data.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.fct.promotion.data.repository")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.fct.promotion.data.entity");
    ...
    @Bean(name = "promotion-datasource", initMethod = "init",destroyMethod = "close")
    @Profile("!build-test")
