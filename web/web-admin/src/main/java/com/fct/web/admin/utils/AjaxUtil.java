...
public class AjaxUtil {
    ...
    /// </summary>
    public static ModelAndView alert(String message)
    {
    ...
    /// </summary>
    public static ModelAndView goUrl(String url,String message)
    {
    ...
    public static ModelAndView remind(String message)
    {
    ...
    /// </summary>
    public static ModelAndView eval(String function)
    {
    ...
    /// 提交多个错误信息
    /// </summary>
    public static ModelAndView error(Map<String, String> dic)
    {
    ...
    static ModelAndView respondJson(String method, String message, String url,String function,Map<String, String> error) {
        ...
        return JsonModelAndViewBuilder.build(body);
    }
}
