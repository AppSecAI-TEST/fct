 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.fct.web.admin.http")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.fct.web.admin.json");
    ...
    @Bean(name = "admin-datasource", initMethod = "init",destroyMethod = "close")
    @Profile("!build-test")
