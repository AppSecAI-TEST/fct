package com.fct.api.http.http.support.version;
...
public final class APIVersionChecker {
    ...
    public static void check() {
        ...
        Reflections reflections = new Reflections("com.wondersgroup.ep.api.http.controllers");
        ...
        for (Class<?> clazz : controllerClasses) {
            ...
            for (Method method : clazz.getDeclaredMethods()) {
                if (Modifier.isPublic(method.getModifiers()) && method.getAnnotation(RequestMapping.class) != null) {
                    ...
                    Preconditions.checkArgument(methodVersion != null, clazz.getSimpleName() + "." + method.getName() + "类和方法上之上要有一个version range注解");
