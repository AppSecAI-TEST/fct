package com.fct.artist.data.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.fct.artist.data.repository")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.fct.artist.data.entity");
    ...
    @Bean(name = "artist-datasource", initMethod = "init",destroyMethod = "close")
    @Profile("!build-test")
