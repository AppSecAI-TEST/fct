package com.fct.mall.data.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.fct.mall.data.repository")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.fct.mall.data.entity");
    ...
    @Bean(name = "mall-datasource", initMethod = "init",destroyMethod = "close")
    @Profile("!build-test")
