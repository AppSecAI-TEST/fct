package com.fct.member.data.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "com.fct.member.data.repository")
...
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("com.fct.member.data.entity");
    ...
    @Bean(name = "member-datasource", initMethod = "init",destroyMethod = "close")
    @Profile("!build-test")
