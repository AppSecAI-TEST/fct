package com.fct.api.http.config;

import com.fct.api.http.http.exceptions.handlers.DefaultExceptionHandler;
import com.fct.api.http.http.exceptions.handlers.ServiceExceptionHandler;
import com.fct.api.http.http.filters.RequestWrapperFilter;
import com.fct.api.http.http.filters.interceptors.*;
import com.fct.api.http.http.support.session.AccessTokenResolver;
import com.fct.api.http.http.support.session.SessionExceptionHandler;
import com.fct.api.http.http.support.version.VersionedRequestMappingHandlerMapping;
import com.fct.api.http.utils.security.ReplayAttackDefender;
import com.fct.api.http.utils.SessionUtil;
